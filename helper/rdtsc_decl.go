...
func HttpProxyTimeout(hc *fasthttp.Client, requestBody []byte, method string, requestURI string, headers map[string]string, timeout time.Duration) ([]byte, int, error) {
